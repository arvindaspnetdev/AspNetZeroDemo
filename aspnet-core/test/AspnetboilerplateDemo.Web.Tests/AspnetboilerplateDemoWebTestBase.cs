...
{
    public abstract class AspnetboilerplateDemoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AspnetboilerplateDemoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AspnetboilerplateDemoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AspnetboilerplateDemoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AspnetboilerplateDemoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AspnetboilerplateDemoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AspnetboilerplateDemoDbContext, Task<T>> func)
        {
            T result;
