...
namespace AspnetboilerplateDemo.Controllers
{
    ...
    public class TokenAuthController : AspnetboilerplateDemoControllerBase
    {
        ...
        {
            return SimpleStringCipher.Instance.Encrypt(accessToken, AspnetboilerplateDemoConsts.DefaultPassPhrase);
        }
    }
}
